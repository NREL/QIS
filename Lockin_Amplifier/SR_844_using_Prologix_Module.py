...
class PrologixAdaptedSR844:
    def __init__(self, resource, gpib_address=8):
    ...
    def collect_data(self, duration, sampling_rate, record_both_channels=True):
        ...
        self.lockin_instance.write('SRAT %d\n' % sampling_rate_index)  # Set the data sample rate to the desired rate
